...
namespace TargetMapperData
{
    ...
    public partial class RDM_BUS_UNIT_CODE_MAPPING
    {
        public decimal BUS_UNIT_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_BUS_UNIT_CODE { get; set; }
        public string SRC_BUS_UNIT_DESC { get; set; }
        public string TRG_BUS_UNIT_CODE { get; set; }
        public string TRG_BUS_UNIT_DESC { get; set; }
