...
namespace TargetMapperData
{
    ...
    public partial class RDM_COUNTY_UNIT_CODE_MAPPING
    {
        public decimal COUNTY_UNIT_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_COUNTY_UNIT_CODE { get; set; }
        public string SRC_COUNTY_UNIT_DESC { get; set; }
        public string TRG_COUNTY_UNIT_CODE { get; set; }
        public string TRG_COUNTY_UNIT_DESC { get; set; }
