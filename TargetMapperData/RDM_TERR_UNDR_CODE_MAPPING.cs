...
namespace TargetMapperData
{
    ...
    public partial class RDM_TERR_UNDR_CODE_MAPPING
    {
        public decimal TERR_UNDR_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_TERR_UNDR_CODE { get; set; }
        public string SRC_TERR_UNDR_DESC { get; set; }
        public string TRG_TERR_UNDR_CODE { get; set; }
        public string TRG_TERR_UNDR_DESC { get; set; }
