...
namespace TargetMapperData
{
    ...
    public partial class RDM_ASL_CODE_MAPPING
    {
        public decimal ASL_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_ASL_CODE { get; set; }
        public string SRC_ASL_DESC { get; set; }
        public string TRG_ASL_CODE { get; set; }
        public string TRG_ASL_DESC { get; set; }
