...
namespace TargetMapperData.Domain
{
    ...
    public partial class RDM_CAT_CODE_MAPPING
    {
        public decimal CAT_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_CAT_CODE { get; set; }
        public string SRC_CAT_DESC { get; set; }
        public string TRG_CAT_CODE { get; set; }
        public string TRG_CAT_DESC { get; set; }
