...
namespace TargetMapperData.Domain
{
    ...
    public partial class RDM_COVERAGE_CODE_MAPPING
    {
        public decimal COVERAGE_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_COVERAGE_CODE { get; set; }
        public string SRC_COVERAGE_DESC { get; set; }
        public string TRG_COVERAGE_CODE { get; set; }
        public string TRG_COVERAGE_DESC { get; set; }
