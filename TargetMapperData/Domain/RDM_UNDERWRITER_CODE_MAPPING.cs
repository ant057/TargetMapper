...
namespace TargetMapperData.Domain
{
    ...
    public partial class RDM_UNDERWRITER_CODE_MAPPING
    {
        public decimal UNDERWRITER_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_UNDERWRITER_CODE { get; set; }
        public string SRC_UNDERWRITER_DESC { get; set; }
        public string TRG_UNDERWRITER_CODE { get; set; }
        public string TRG_UNDERWRITER_DESC { get; set; }
