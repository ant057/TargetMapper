...
namespace TargetMapperData.Domain
{
    ...
    public partial class RDM_MGMT_SEG_CODE_MAPPING
    {
        public decimal MGMT_SEG_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_MGMT_SEG_CODE { get; set; }
        public string SRC_MGMT_SEG_DESC { get; set; }
        public string TRG_MGMT_SEG_CODE { get; set; }
        public string TRG_MGMT_SEG_DESC { get; set; }
