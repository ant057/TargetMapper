...
namespace TargetMapperData.Domain
{
    ...
    public partial class RDM_USERLINE_CODE_MAPPING
    {
        public decimal USERLINE_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_USERLINE_CODE { get; set; }
        public string SRC_USERLINE_DESC { get; set; }
        public string TRG_USERLINE_CODE { get; set; }
        public string TRG_USERLINE_DESC { get; set; }
