...
namespace TargetMapperData
{
    ...
    public partial class RDM_COUNTY_UNIT_CODE
    {
        public decimal COUNTY_UNIT_ID { get; set; }
        public string COUNTY_UNIT_CODE { get; set; }
        public string COUNTY_UNIT_DESC { get; set; }
