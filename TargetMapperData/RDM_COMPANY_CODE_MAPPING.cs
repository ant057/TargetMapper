...
namespace TargetMapperData
{
    ...
    public partial class RDM_COMPANY_CODE_MAPPING
    {
        public decimal COMPANY_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_COMPANY_CODE { get; set; }
        public string SRC_COMPANY_DESC { get; set; }
        public string TRG_COMPANY_CODE { get; set; }
        public string TRG_COMPANY_DESC { get; set; }
