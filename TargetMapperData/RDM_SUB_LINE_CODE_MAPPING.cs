...
namespace TargetMapperData
{
    ...
    public partial class RDM_SUB_LINE_CODE_MAPPING
    {
        public decimal SUB_LINE_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_SUB_LINE_CODE { get; set; }
        public string SRC_SUB_LINE_DESC { get; set; }
        public string TRG_SUB_LINE_CODE { get; set; }
        public string TRG_SUB_LINE_DESC { get; set; }
