...
namespace TargetMapperData
{
    ...
    public partial class RDM_GRPLINE_CODE_MAPPING
    {
        public decimal GRPLINE_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_GRPLINE_CODE { get; set; }
        public string SRC_GRPLINE_DESC { get; set; }
        public string TRG_GRPLINE_CODE { get; set; }
        public string TRG_GRPLINE_DESC { get; set; }
