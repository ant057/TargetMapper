...
namespace TargetMapperData
{
    ...
    public partial class RDM_CLASS_CODE_MAPPING
    {
        public decimal CLASS_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_CLASS_CODE { get; set; }
        public string SRC_CLASS_DESC { get; set; }
        public string TRG_CLASS_CODE { get; set; }
        public string TRG_CLASS_DESC { get; set; }
