...
namespace TargetMapperData
{
    ...
    public partial class RDM_AGENT_CODE_MAPPING
    {
        public decimal AGENT_CODE_ID { get; set; }
        public string SOURCE_SYSTEM { get; set; }
        public string SRC_AGENT_CODE { get; set; }
        public string SRC_AGENT_DESC { get; set; }
        public string TRG_AGENT_CODE { get; set; }
        public string TRG_AGENT_DESC { get; set; }
